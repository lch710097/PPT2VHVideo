var serverurl="http://localhost:8888";  //后台服务
...
var registerurl=serverurl+"/api/register";


var loginurl=serverurl+"/api/login";


var getuserurl=serverurl+"/api/@me";

var updateuserpassurl=serverurl+"/api/updateuser";

var logoutuserpassurl=serverurl+"/api/logout";